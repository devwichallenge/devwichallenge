package com.nisum.demo.config.security;

import com.nisum.demo.config.filter.FilterConfig;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) {
        web.ignoring().antMatchers("/", "/index.html", "/approval/user");
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and()
                .authorizeRequests()
                .antMatchers("/", "/index.html", "/approval/user")
                .permitAll()
